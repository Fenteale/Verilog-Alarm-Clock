...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { alarm }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { speaker }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
